...
![图13.1 渲染方法谱系](Real-Time_Rendering_4th_中文/assets/fig_13_1_13.1.png)
...
![图 13.2 多洛雷斯教堂全景图及由它生成的三个视图](Real-Time_Rendering_4th_中文/assets/fig_13_3_13_2.png)
...
![数学公式](Real-Time_Rendering_4th_中文/assets/math/eq_13_03_eaf289bd53e8cf.png)
...
![图 13.3：使用 Talisman 模拟器渲染的《Chicken Crossing》动画静帧及部分精灵图层](Real-Time_Rendering_4th_中文/assets/fig_13_5_13.3.png)
...
![图13.4](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.4.png)
...
![数学公式](Real-Time_Rendering_4th_中文/assets/math/eq_13_06_29d5351e10d24d.png)


反之，如果向上方向固定（例如地形上的树木等轴向对齐公告板），则新的法线向量 **n′** 为


![数学公式](Real-Time_Rendering_4th_中文/assets/math/eq_13_06_b7dabb1b0b0f23.png)


随后将新向量归一化，并用这三个向量构成旋转矩阵。例如，固定法线 **n** 并调整向上向量 **u′** 时，矩阵为


![数学公式](Real-Time_Rendering_4th_中文/assets/math/eq_13_06_2725f94b48811c.png)


![图13.5](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.5.png)
...
最简单的公告板形式是**屏幕对齐公告板**。这种形式与二维精灵相同：图像始终平行于屏幕，并具有恒定的向上向量。相机将场景渲染到一个与近、远裁剪平面平行的观察平面上。我们通常把这个假想平面想象为位于近裁剪平面的位置。对于这类公告板，期望的表面法线是观察平面法线的反向；观察平面法线 ![数学符号](Real-Time_Rendering_4th_中文/assets/math/eq_13_06_829c1f25e1a3e5.png) 指向远离观察位置的方向。向上向量 **u** 来自相机自身，它位于观察平面内，定义相机的向上方向。这两个向量已经垂直，因此只需“向右”方向向量 **r**，就能构成公告板的旋转矩阵。由于 **n** 和 **u** 对相机而言是常量，这一类所有公告板的旋转矩阵都相同。
...
![图13.6](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.6.png)

图 13.6. 宽视场角下的四个球体。左上方是使用观察平面对齐的球体公告板纹理。右上方公告板采用视点定向。下排展示两个真实球体。


![图13.7](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.7.png)
...
![图13.8](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.8.png)
...
![图13.9](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.9.png)
...
![图13.10](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.10.png)
...
![图13.11](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.11.png)
...
![图13.12](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.12.png)
...
![图13.13](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.13.png)
...
![图13.14](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.14.png)
...
![图13.15](Real-Time_Rendering_4th_中文/assets/fig_13_6_13.15.png)
...
![图13.16 深度精灵与普通替身的比较](Real-Time_Rendering_4th_中文/assets/fig_13_7_13.16.png)
...
![图13.17 使用四个高度场纹理构建的编织表面](Real-Time_Rendering_4th_中文/assets/fig_13_7_13.17.png)
...
![图13.18 浮雕替身](Real-Time_Rendering_4th_中文/assets/fig_13_7_13.18.png)
...
![图 13.19 粒子系统示例](Real-Time_Rendering_4th_中文/assets/fig_13_8_13.19.png)
...
除了光照之外，粒子的体积阴影及自阴影的生成也需要特别处理。对于接收其他遮挡物投下的阴影，小粒子通常只需在顶点处进行阴影贴图测试，而不必逐像素测试。由于粒子是一些离散的点，并被渲染为简单的朝向摄像机的四边形，因此无法通过在阴影贴图中进行光线步进来实现向其他物体投射阴影。不过，可以使用泼溅方法（第 13.9 节）。为了在太阳照射下向其他场景元素投射阴影，可以将粒子泼溅到纹理中，在一个首先清为 1 的缓冲区里，逐像素乘入其透射率 ![数学符号](Real-Time_Rendering_4th_中文/assets/math/eq_13_08_6f5181af144fb0.png)。纹理可以只包含一个通道来表示灰度透射率，也可以包含三个通道来表示彩色透射率。这些纹理按照阴影级联的层级应用于场景：将该透射率与常规不透明阴影级联所得到的可见性相乘，具体见第 7.4 节。这种技术实际上提供了单层透明阴影 [44]。它唯一的缺点是，粒子可能会错误地向位于粒子与太阳之间的不透明元素反向投射阴影。通常可以通过仔细的关卡设计来避免这一问题。
...
![图 13.21 命运2中的粒子系统](Real-Time_Rendering_4th_中文/assets/fig_13_8_13.21.png)
...
![图13.22 使用圆形泼溅片渲染的Lucy模型](Real-Time_Rendering_4th_中文/assets/fig_13_9_13.22.png)
...
![图13.23 分层点云](Real-Time_Rendering_4th_中文/assets/fig_13_9_13.23.png)
...
![图13.24 不同点数预算的小镇点云](Real-Time_Rendering_4th_中文/assets/fig_13_9_13.24.png)
...
![图13.25 法线着色、屏幕空间环境光遮蔽和眼穹光照的比较](Real-Time_Rendering_4th_中文/assets/fig_13_9_13.25.png)
...
![图13.26 带有逐像素深度的环境捕获](Real-Time_Rendering_4th_中文/assets/fig_13_9_13.26.png)
...
![图13.27 体素的应用](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_27.png)
...
![图13.28 稀疏体素八叉树](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_28.png)

**图 13.28：** 以二维形式展示的稀疏体素八叉树。给定左侧的一组体素，沿树向上记录哪些父节点中含有体素。右侧是最终八叉树的可视化，显示每个网格位置所存储的最深层节点。（据 Laine 和 Karras [963] 的图绘制。）


![图13.29 不同细节层次的体素光线追踪](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_29.png)
...
![图13.30 三种体素化方式](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_30.png)
...
![图13.31 立方体剔除](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_31.png)
...
![图13.32 移动立方体](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_32.png)
...
![图13.33 锥体追踪阴影](Real-Time_Rendering_4th_中文/assets/fig_13_10_13_33.png)
